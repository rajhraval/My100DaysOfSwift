...
class ViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        if let savedCount = defaults.object(forKey: "viewCounts") as? [String: Int] {
            counter = savedCount
        }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.detailTextLabel?.text = "Picture Viewed: \(counter[pictures[indexPath.row]] ?? 0) times"
        return cell
    }
    ...
    func save() {
        let defaults = UserDefaults.standard
        defaults.set(counter, forKey: "viewCounts")
    }
